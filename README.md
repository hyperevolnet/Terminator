...
[12-07-2024] You guys only download code and don't want to star, so future version will not be open source. Of course, this paper will not be submitted to peer review again. Reshaping the LLM is only part of the future version.
